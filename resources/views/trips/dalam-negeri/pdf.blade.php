...
<body>
    ...
    <div class="rincian-biaya">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">1</td>
                    <td>Paket</td>
                    <td class="text-right">Rp {{ number_format($trip->biaya_transport, 0, ',', '.') }}</td>
                </tr>
                <tr>
                    ...
                    <td class="text-center">1</td>
                    <td>Paket</td>
                    <td class="text-right">Rp {{ number_format($trip->biaya_hotel, 0, ',', '.') }}</td>
                </tr>
                <tr class="total-row">
        ...
        <p style="margin-top: 10px; font-style: italic;">
            Terbilang: <strong>{{ app(\App\Http\Controllers\TripController::class)->terbilang($trip->total_biaya) }} Rupiah</strong>
        </p>
    </div>
